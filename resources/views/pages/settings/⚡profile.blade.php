...
<section class="w-full">
    ...
    <x-pages::settings.layout :heading="__('Profile')" :subheading="__('Update your name and email address')">
        ...
        <div class="rounded-xl border border-border bg-card p-5 mb-6 flex flex-col sm:flex-row items-center gap-5">
        ...
        <form wire:submit="savePreferences" class="space-y-4 rounded-xl border border-border bg-card p-5 mt-6">
